...
/*Operatörler, Koşullu İfadeler, Döngüler:*/
    ...
    double division = static_cast<double>(num1) / num2; // static_cast<double> operatörü bir veri tipini başka veri tipi dönüştürmeye yarar.
